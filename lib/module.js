...
module.exports = function (moduleOptions) {
  ...
  /** @see {@link https://nuxtjs.org/api/configuration-build#transpile} */
  const transpileOptionExists = Array.isArray(this.options.build.transpile);

  if (transpileOptionExists) this.options.build.transpile.push(/vue-cli-plugin-apollo/)
  ...
  this.extendBuild((config, {isServer}) => {
    ...
    if (isServer && !transpileOptionExists) {
      config.externals = [
        nodeExternals({
